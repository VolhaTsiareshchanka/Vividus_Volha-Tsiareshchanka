...
!--GivenStories: story/tasks2/preconditionTask2_2.story!-- When I enter `${email_var}` in field located `By.xpath(//input[@id='user'])` - 12!-- When I enter `${password_var}` in field located `By.xpath(//input[@id='password'])` - 16
